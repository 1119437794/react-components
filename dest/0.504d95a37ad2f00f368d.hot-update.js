...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index = function (_Component) {
	    ...
	    function Index() {
	        ...
	        _this.state = {
	            dataSource: ['数据1', '数据2', '数据3']
	        };

	        _this.autoChange = function (index) {
	            console.log(index);
	        };
	        return _this;
	    }
	...
	var AutoComplete = function (_Component) {
	    ...
	    _createClass(AutoComplete, [{
	        ...
	        value: function render() {
	            ...
	            var listClass = state.show ? 'auto_list' : 'auto_list auto_list-hide';

	            return _react2.default.createElement(
	                'div',
	                { className: 'auto_root' },
	                _react2.default.createElement('input', { className: 'auto_input', type: 'text' }),
